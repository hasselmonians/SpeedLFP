...
for slnum = 1:length(dat);
    ...
    clear f; clear datum; clear inds;
    f = arrayfun(@(x) x.si, dat(slnum).crunched.cell,'UniformOutput',0);
    ctp = 2;
    ...
    %datum = datum(inds,:)*(1/.275)/2; %for nearest six units
    datum = datum(inds,:);
...
field = 'rhythmicity_base_f';
field_filt = 'rhythmicity_p_rhythmic';
thresh = 0.05;
ctp = 2;
...
for slnum = 1:length(dat)
    for field = 32:33%1:length(fields)
...
fields = {
    ...
    'poi_sfr_inter', ...5
    'poi_sfr_slope', ...6
    'rhythmicity_base_tau', ...7
    'rhythmicity_base_b', ...8
    'rhythmicity_base_c', ...9
    'rhythmicity_base_f', ...10
    'rhythmicity_base_s', ...11
    'rhythmicity_base_r', ...12
    'rhythmicity_skip', ...13
    'rhythmicity_frequency0', ...14
    'rhythmicity_frequency_intercept', ...15
    'rhythmicity_frequency_slope', ...16
    'rhythmicity_amplitude0', ...17
    'rhythmicity_amplitude_intercept', ...18
    'rhythmicity_amplitude_slope',...19
    'theta_mrl',...20
    'theta_mra',...21
    };
...
filters = {
    ...
    'poi_sfr_p', ...5
    'poi_sfr_p', ...6
    'rhythmicity_p_rhythmic', ...7
    'rhythmicity_p_rhythmic', ...8
    'rhythmicity_p_rhythmic', ...9
    'rhythmicity_p_rhythmic', ...10
    'rhythmicity_p_rhythmic', ...11
    'rhythmicity_p_rhythmic', ...12
    'rhythmicity_p_skip', ...13
    'rhythmicity_p_freq', ...14
    'rhythmicity_p_freq', ...15
    'rhythmicity_p_freq', ...16
    'rhythmicity_p_amp', ...17
    'rhythmicity_p_amp', ...18
    'rhythmicity_p_amp', ...19
    'theta_pr',...20
    'theta_pr',...21
    };
...
clear inds
for slnum = 1:length(dat)
    for field = 20:21%1:length(fields)
